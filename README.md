...
Here is a list of a couple of projects I'm working on. There's this project - Toile - and then there is a [hush box](https://thehometheaterdiy.com/projector-hush-box/) that I'm going to make for my projector. Let's look at what I've entered already for the hush box. Clicking on the circle on the right gives us:
...
Buying materials isn't really part of the planning phase, so we can rearrange the list, (currently by scrolling down to where there are two navigable lists and dragging and dropping):
...
Maybe Larry borrowed a bunch of things, including the tools you need to make this project. You need to get them back, but not all of the things you need to get back fit into the hierarchy of this project. Adding it as its own project:
