...
const makeDraggable = function(element,props,store) {
    ...
    const onMouseUp = e => {
        ...
        const timeSegment = document.elementFromPoint(position.x+position.width/2, position.y+3)
        ...
        store.dispatch('updateStartTime',{newStartTime: newTime, id:props.entry.id})
